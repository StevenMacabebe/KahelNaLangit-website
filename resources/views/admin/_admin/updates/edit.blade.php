...
<head>
    ...
    <style>
        ...
        .preview-image { max-width: 200px; max-height: 150px; border-radius: 10px; border: 2px solid #e67e22; padding: 5px; object-fit: cover; }
                        ...
                        <form method="POST" action="{{ route('admin.updates.update', $update->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="category" name="category" required>
                                    ...
                                    <option value="project_update" {{ $update->category === 'project_update' ? 'selected' : '' }}>Project Update</option>
                                </select>
                            </div>

                            <div class="mb-3">
                                <label for="content" class="form-label">Content</label>
                                <textarea class="form-control" id="content" name="content" rows="8" required>{{ $update->content }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label for="event_date" class="form-label">Event Date (optional)</label>
                                <input type="date" class="form-control" id="event_date" name="event_date" value="{{ $update->event_date }}">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <small class="upload-hint">Upload a new image to replace the current one. Max 2MB.</small>
                            </div>
